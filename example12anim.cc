...
#define LESS_CLIPPING (10)  
  ...
  for(double a3=0.0;a3<360.0;a3+=360.0/720.0) {
  		...
  		for(int r=35;r<=100;r+=5) {
    			...
    			P.pisak(11);
    			P.elipsa3(RX-RY/3-150, RY/2, 3*r-(90+60-r-r/2), 3*r, 0, 360, a3,0xffffff, r>70);
    			P.pisak(7);
    			P.elipsa3(RX-RY/3-150, RY/2, 3*r-(90+60-r-r/2), 3*r, 0, 360, a3,r<=70?0xffffa0:0xff9b00, r>70);
    			P.pisak(3);
